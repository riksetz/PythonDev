# Treasure Island. Day 3 Project. Date: Friday, 08/09/2023.
    ...
    if turn == "l":
        ...
        if river == "2":
            ...
            if compass == "n" or compass == "s":
                print (f"Congratualtions, WINNER! {player} and their sailor friend Jack find the treasure chest and return home safely.\n")
                print (f'''
                *******************************************************************************
                         |                   |                  |                     |
